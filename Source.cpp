...
public://паблик секция
	...
	void print_mm();//метод, выводящий наименование доступных полей для нахождения минимального или максимального
	void print_data();//метод, выводящий данные полей объекта
	void set_data();//метод, осуществляющий ввод данных в объект
	void write_file(vector<inventory>& arr, string path);//метод, осуществляющий запись данных в файл
	void read_file(vector<inventory>& arr, string path);//метод, осуществляющий чтение данных из файла 
